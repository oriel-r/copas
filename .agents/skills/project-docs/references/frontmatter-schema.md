...
| `supersededBy` | string | Condicional | Ruta absoluta al documento que lo sustituye. | Obligatorio si `status` es `superseded` (ej. `"/docs/agencias/onboarding.md"`). En otros casos usar `""`. |
