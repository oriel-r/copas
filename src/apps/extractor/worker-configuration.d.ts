/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: d829ec8508dcb800381e9997d898ac07)
...
interface __BaseEnv_CloudflareBindings {
	...
	EXTRACTION_WORKFLOW: Workflow<Parameters<import("./src/index").PolicyExtractionWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_MODEL" | "MISTRAL_API_KEY">> {}
}
declare module "*.md" {
	const value: string;
