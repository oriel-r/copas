/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=infra/cloudflare/wrangler.jsonc --env-interface=CloudflareBindings` (hash: a8d72d7e0436789e9338bdbabee5886d)
// Runtime types generated with workerd@1.20260730.1 2026-08-06 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	AUTH_KV: KVNamespace;
	DB: D1Database;
	BETTER_AUTH_URL: "https://api-staging.example.com" | "http://localhost:8787";
	CLIENT_URL: "https://app-staging.example.com" | "http://localhost:5173";
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		CLIENT_URL: "https://app-staging.example.com";
		NODE_ENV: "staging";
		BETTER_AUTH_SECRET: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "CLIENT_URL" | "NODE_ENV" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "MICROSOFT_CLIENT_ID" | "MICROSOFT_CLIENT_SECRET" | "MICROSOFT_TENANT_ID">> {}
}
