/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=infra/cloudflare/wrangler.jsonc --env-interface=CloudflareBindings` (hash: 1413c57c72606edac78aacdc495ab76f)
// Runtime types generated with workerd@1.20260811.1 2026-08-06 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	AUTH_KV: KVNamespace;
	DOCUMENT_BUCKET: R2Bucket;
	DB: D1Database;
	AI_QUEUE: Queue;
	BACKEND_URL: "https://api-staging.orielromero-work.workers.dev" | "http://localhost:8788";
	BETTER_AUTH_URL: "https://api-staging.orielromero-work.workers.dev" | "http://localhost:8788";
	CLIENT_URL: "https://client-staging.orielromero-work.workers.dev" | "http://localhost:5173";
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		DB: D1Database;
		AI_QUEUE: Queue;
		BACKEND_URL: "https://api-staging.orielromero-work.workers.dev";
		BETTER_AUTH_URL: "https://api-staging.orielromero-work.workers.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BACKEND_URL" | "BETTER_AUTH_URL" | "CLIENT_URL" | "NODE_ENV" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "MICROSOFT_CLIENT_ID" | "MICROSOFT_CLIENT_SECRET" | "MICROSOFT_TENANT_ID">> {}
}
